...
const textoPausa = document.querySelector('.comenzar-texto')
...
botonIniciarPausar.addEventListener('click', cambiarPausar);
...
function cambiarPausar (){
    if (textoPausa.textContent === 'Comenzar') {
        textoPausa.textContent = 'Pausar';
        iconoPausa.setAttribute("src", "./imagenes/pause.png")
    } else {
        textoPausa.textContent = 'Comenzar';
